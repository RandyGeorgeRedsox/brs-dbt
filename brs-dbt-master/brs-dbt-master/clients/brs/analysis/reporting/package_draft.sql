...
, cte_OLI AS (
    ...
    FROM cte_OL OL
        ...
        LEFT OUTER JOIN cte_SC SC
            on SC.ORDER_ID = OL.ORDER_ID 
        INNER JOIN cte_PL PL
...
, cte_SR AS (
    ...
    FROM cte_OLI OLI
        ...
        LEFT OUTER JOIN cte_SR SR
            on SR.SALES_REP_ID = PO.SALES_REP_ID 
        LEFT OUTER JOIN REDSOXR.SALES_REP_SUB_GROUP RS                 
